...
public class BaseDaoImpl<T> extends HibernateDaoSupport implements IBaseDao<T> {
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findByColumn(final Class<T> clazz, final String column, final Object value)
			throws HibernateException {
		return getSessionFactory().getCurrentSession().createCriteria(clazz).add(Restrictions.eq(column, value)).list();
	}

	@SuppressWarnings("unchecked")
	public <X> X findUniqueByColumn(final Class<T> clazz, final String column, final Object value)
			throws HibernateException {
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findByTwoOredColumn(final Class<T> clazz, String emailValue, final String cellPhoneValue)
			throws HibernateException {
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findByIdAndColumn(final Class<T> clazz, final String idColumn, final String column,
			final Long idValue, final String columnValue) throws HibernateException {
	...
	@SuppressWarnings("unchecked")
	public <X> X findUnique(final String paramString, final Map<String, Object> paramMap, final Class<T> clazz)
			throws HibernateException {
	...
	protected Query createQuery(final String queryString, final Map<String, Object> values, final Class clazz)
			throws HibernateException {
	...
	@SuppressWarnings("rawtypes")
	protected Query createQuery(final String queryString, final Map<String, Object> values, final Class clazz,
			final int maxResults) throws HibernateException {
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findAll(final String queryString, final Class<T> className, final Map<String, Object> map)
			throws HibernateException {
		final Session session = getSessionFactory().getCurrentSession();
		final Query query = session.createQuery(queryString).setCacheable(true);
		if (map != null) {
	...
	public void delete(final String paramString, final Map<String, Object> paramMap)
	...
	@SuppressWarnings("unchecked")
	public List<Long> find(final String string, final Map<String, Object> paramMap,
			final Map<String, List<Long>> listMap) {
		final Session session = getSessionFactory().getCurrentSession();
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findAll(final String queryString, final Map<String, Object> map, final int start,
			final int amount, final Class<T> className) throws HibernateException {
		final Session session = getSessionFactory().getCurrentSession();
		final Query query = session.createQuery(queryString).setCacheable(true);
		if (map != null) {
			query.setProperties(map);
	...
	@SuppressWarnings("unchecked")
	public <X> List<X> findAll(final Class<T> clazz, final String fieldName, final List<Long> idList)
			throws HibernateException {
		final org.hibernate.Criteria criteria = getSessionFactory().getCurrentSession().createCriteria(clazz);
